...
-- ============================================================================
INSERT INTO workout_programs (id, quest_template_id, trainer_id, name, description, duration_weeks, workouts_per_week, difficulty, is_template) VALUES
(1, 16, NULL, 'Summer Beach Body Program', 'Get beach-ready with this comprehensive 12-week program focusing on fat loss and muscle definition', 12, 4, 'intermediate', 1);
...
INSERT INTO exercises (workout_day_id, name, sets, reps, rest_seconds, notes) VALUES
...
-- ============================================================================
INSERT INTO workout_programs (id, quest_template_id, trainer_id, name, description, duration_weeks, workouts_per_week, difficulty, is_template) VALUES
(2, 17, NULL, 'Wedding Ready Program', 'Look stunning on your special day with this 16-week comprehensive transformation program', 16, 5, 'intermediate', 1);
...
-- ============================================================================
INSERT INTO workout_programs (id, quest_template_id, trainer_id, name, description, duration_weeks, workouts_per_week, difficulty, is_template) VALUES
(4, 28, NULL, 'Beginner Fitness Journey', 'Perfect for beginners starting their fitness journey, progressive and sustainable', 8, 3, 'beginner', 1);
...
-- ============================================================================
INSERT INTO workout_programs (id, quest_template_id, trainer_id, name, description, duration_weeks, workouts_per_week, difficulty, is_template) VALUES
(6, 32, NULL, 'Booty Builder', 'Comprehensive glute-focused program to build and shape', 10, 4, 'intermediate', 1);
